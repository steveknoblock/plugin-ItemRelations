<div class="field">
    <?php echo get_view()->formLabel('item_relations_item_relation', 'Item Relation'); ?>
    <div class="inputs">
        ...
        <?php echo get_view()->formSelect('item_relations_property_id', null, array('multiple' => false), $formSelectProperties); ?>
