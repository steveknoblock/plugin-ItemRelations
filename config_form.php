<div class="field">
    <?php echo get_view()->formLabel('item_relations_public_append_to_items_show', 'Append to Public Item Show'); ?>
    <div class="inputs">
...
<div class="field">
    <?php echo get_view()->formLabel('item_relations_relation_format', 'Relation Format'); ?>
    <div class="inputs">
